  ...
  return (
    <div className="consultation-preview">
      ...
      <div className="space-y-6 bg-white p-6 rounded-lg border border-gray-200">
        ...
        {/* Billing and Payment Section - Side by Side */}
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-3 border-b pb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                    ...
                    <Table.Summary>
                      <Table.Summary.Row className="bg-green-50">
                        <Table.Summary.Cell index={0} colSpan={2} align="right">
                          <strong className="text-sm">Total Paid:</strong>
                        </Table.Summary.Cell>
                        <Table.Summary.Cell index={1} align="right">
                ...
                <div className="bg-red-50 border border-red-200 rounded p-3">
                  <div className="flex justify-between items-center">
                    <span className="font-bold text-base text-gray-900">Balance Due:</span>
            ...
            <div className={values.payments.length === 0 ? 'md:col-span-2 max-w-xl ml-auto' : ''}>
